...
if (isset($_GET['id'])) {
    ...
    $sql = "select * from myproduct where id=$id";
...
<body>
    ...
    <main id="main">
        ...
        <div class="container mt-4">
            ...
            <h2 style="color:#CE1212">Ubah Data Buku</h2>
            <p class="small text-muted">Lengkapi formulir berikut untuk melanjutkan</p>
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control text-capitalize" placeholder="Judul" name="judul" value="<?php echo $data['judul']; ?>" autocapitalize="word" required>
                </div>

                <label class="form-label">Penulis</label>
                <div class="input-group mb-3">
                    <input type="text" class="form-control text-capitalize" placeholder="Penulis" name="penulis" value="<?php echo $data['penulis']; ?>" autocapitalize="word" required>
                </div>

                <label class="form-label">Penerbit & Tahun Terbit</label>
                <div class="input-group mb-3">
                    <input type="text" class="form-control text-capitalize" value="<?php echo $data['penerbit']; ?>" placeholder="Penerbit" name="penerbit" autocapitalize="word" required>
                    <input type="text" class="form-control ms-2" placeholder="Tahun Terbit" name="tahun" value="<?php echo $data['tahun']; ?>" required>
                </div>

                <label class="form-label">Deskripsi</label>
                <div class="input-group mb-3">
                    <textarea class="form-control" placeholder="Deskripsi (Optional)" name="deskripsi"><?php echo $data['deskripsi']; ?></textarea>
                </div>

                <label for="basic-url" class="mt-4">
                    <h5>Spesifikasi</h5>
                </label><br>
                ...
                <div class="input-group mb-3">
                    <input type="number" min="25" max="100" class="form-control" placeholder="Kondisi" name="kondisi" value="<?php echo $data['kondisi']; ?>" required>
                    <span class="input-group-text">%</span>
                </div>

                <label class="form-label">Stok</label>
                <div class="input-group mb-3">
                    <input type="number" min="1" max="100" class="form-control" placeholder="Stok" name="stok" value="<?php echo $data['stok']; ?>" required>
                </div>

                <label for="basic-url" class="mt-3">
                ...
                <div class="section-header mt-4">
                    <button type="submit" name="sumbit" class="btn shadow" style="font-weight: 500; font-size: 14px; letter-spacing: 1px; display: inline-block;
                        padding: 12px 36px; border-radius: 50px; transition: 0.5s; background-color:#CE1212; color:white">Ubah Produk</button>
