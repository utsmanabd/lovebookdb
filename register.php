                            ...
                            <div class="container" style="padding: 15px;">
                                <form action="" method="POST" class="login-email">
                                    ...
                                    <div class="section-header">
                                        <p>Gabung ke<span> Lovebook</span></p>
                                        <h2>Lengkapi form untuk mendaftar</h2>
                                    </div>
                                    <div class="mb-3">
                                        <label for="username1" class="form-label">Username</label>
                                        <input class="form-control rounded-3" type="text" placeholder="Masukkan username" name="username" value="<?php echo $username; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="email1" class="form-label">Alamat Email</label>
                                        <input class="form-control rounded-3" type="email" placeholder="Masukkan email Anda" name="email" value="<?php echo $email; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="password1" class="form-label">Kata Sandi</label>
                                        <input class="form-control rounded-3" type="password" placeholder="Masukkan password" name="password" value="<?php echo $_POST['password']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="confirm_password" class="form-label">Konfirmasi Kata Sandi</label>
                                        <input class="form-control rounded-3" type="password" placeholder="Konfirmasi password" name="cpassword" value="<?php echo $_POST['cpassword']; ?>" required>
                                    </div>
                                    <div class="section-header mt-4">
                                        <button name="submit" class="btn" style="font-weight: 500; font-size: 14px; letter-spacing: 1px; display: inline-block;
                                        padding: 12px 36px; border-radius: 50px; transition: 0.5s; background-color:#CE1212; color:white">DAFTAR</button>
                                    </div>
